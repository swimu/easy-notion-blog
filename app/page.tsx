  ...
  <>
    ...
    <div className={styles.container}>
      <div>
        ...
        <h2>すいむ (<Link href="https://twitter.com/swimuuu">@swimuuu</Link>)って？</h2>
<Image src="/images/flyingRubberDuck.jpeg" width={200} height={200} alt="My avatar" />
      ...
      <p>このサイトは  <Link href="https://github.com/otoyo/easy-notion-blog">easy-notion-blog</Link> を使って公開しています。</p>
      ...
      <br/>
    <h2>連絡をとりたい</h2>
    <p>Twitterアカウント(<Link href="https://twitter.com/swimuuu">@swimuuu</Link>)で待っています。</p>
      </div>
    </div>
  </>
)
